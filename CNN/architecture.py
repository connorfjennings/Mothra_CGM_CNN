...
def get_architecture(arch, hidden, dr, channels=1):
    ...
    elif arch=='ho3_err': return model_ho3_err(hidden, dr, channels)
    elif arch=='hp3_err': return model_hp3_err(hidden, dr, channels)
    elif arch=='UNetSmall':  return model_UNetSmall(hidden, dr, channels, 2)
...
#####################################################################################
#####################################################################################
class model_ho3_err(nn.Module):
    def __init__(self, hidden, dr, channels):
        super(model_ho3_err, self).__init__()
