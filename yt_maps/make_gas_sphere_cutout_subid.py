...
outdir     = "/vast/palmer/scratch/vandokkum/cj535/TNG50_cutouts/MW_sample"
outfile    = f"TNG50_snap{snapnum:03d}_subid{sub_id:06d}_gas_sphere_500kpc.hdf5"
...
sub = il.groupcat.loadSingle(basepath, snapnum, subhaloID=sub_id)
center_ckpch = sub['SubhaloPos'].astype(np.float64)
